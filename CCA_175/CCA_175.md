...
Import the docker image:
	...
	docker run --hostname=quickstart.cloudera --privileged=true -t -i -p 7180:7180 -p 80:80 -p 8888:8888 -p 7187:7187 -p 8088:8088 -p 19888:19888 --name cca175 cloudera/quickstart /usr/bin/docker-quickstart
